...
object AppInjector {
    ...
    fun init(customApplication: CustomApplication) {
        appComponent = DaggerAppComponent.builder().application(customApplication).build()
        appComponent.inject(customApplication)
        customApplication.registerActivityLifecycleCallbacks(object : Application.ActivityLifecycleCallbacks {
